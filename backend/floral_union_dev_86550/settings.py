"""
Django settings for floral_union_dev_86550 project.
...
ROOT_URLCONF = 'floral_union_dev_86550.urls'
...
WSGI_APPLICATION = 'floral_union_dev_86550.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "floral_union_dev_86550 API",
    "DESCRIPTION": "API documentation for floral_union_dev_86550 App",
    "VERSION": "v1",
}
